"""
【任务1】【linton】基于市值和大户机构买入额构建的选股策略_73.86%_-26.47%_2.79
https://bbs.quantclass.cn/thread/68322
...
# data_center_path = Path("E:/03-Quantitative/data")
...
strategy = {
    ...
    'select_num': 5,  # 选股量，可以是整数，也可以是小数，比如 0.1 表示选取 10% 的股票
    "factor_list": [  # 选股因子列表
        # ** 因子格式说明 **
...
#     布林带: [周期, 标准差倍数]
#     趋势线: [周期]
equity_timing = {"name": "止损择时", "params": [9, -0.08]}
