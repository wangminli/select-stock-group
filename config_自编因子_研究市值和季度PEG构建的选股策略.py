"""
标题：【quant_狼蛛】大资金跟随强者恒强策略_40.18%_-26.24%_ 1.53
链接：https://bbs.quantclass.cn/thread/68441
评价：
	亮点：
	缺点：
	15年回撤大小：
...
# data_center_path = Path("E:/Quantclass/quantclass-data-folder")
...
stock_data_path = r"E:\Quantclass\quantclass-data-folder\stock-trading-data-pro"
# (必选) 指数数据路径，全量数据下载链接：https://www.quantclass.cn/data/stock/stock-main-index-data
index_data_path = r"E:\Quantclass\quantclass-data-folder\stock-main-index-data"
# (可选) 财务数据，全量数据下载链接：https://www.quantclass.cn/data/stock/stock-fin-data-xbx
fin_data_path = r"E:\Quantclass\quantclass-data-folder\stock-fin-data-xbx"
...
strategy = {
    ...
    "factor_list": [  # 选股因子列表
        ...
        ('大户机构买入', True, None, 1),
        ('RSI看涨', True, [6, 12, 24, 65], 1),
        ('市值', True, None, 1),
        ('换手率', True, 5, 1),
        ('CCI因子', False, [25, 100], 1),
...
#     布林带: [周期, 标准差倍数]
#     趋势线: [周期]
equity_timing = {"name": "择时止损", "params": [9, -0.08]}
