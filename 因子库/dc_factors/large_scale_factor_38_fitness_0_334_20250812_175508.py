...
large_scale_factor_38_fitness_0_334_20250812_175508: 基于遗传规划算法生成的因子38，适应度: 0.334361
适应度分数: 0.334361
原始GP表达式: ABS_DIFF(MULTIPLY(UPPER_SHADOW, NUMBER_50), NUMBER_34)
...
def add_factor(df: pd.DataFrame, param=None, **kwargs) -> (pd.DataFrame, dict):
    ...
    """
    col_name = kwargs.get('col_name', 'large_scale_factor_38_fitness_0_334_20250812_175508')
    ...
    # 计算因子值
    factor_value = (np.abs((h - np.maximum(o, c) * 50) - 34))  # 原始GP表达式: ABS_DIFF(MULTIPLY(UPPER_SHADOW, NUMBER_50), NUMBER_34)
