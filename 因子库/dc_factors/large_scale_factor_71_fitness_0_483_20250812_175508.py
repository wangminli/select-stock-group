...
large_scale_factor_71_fitness_0_483_20250812_175508: 基于遗传规划算法生成的因子71，适应度: 0.483153
适应度分数: 0.483153
原始GP表达式: CORRELATION10(SQUARED_DIFF(BODY_SIZE, NUMBER_56), SUBTRACT(LOW, NUMBER_51))
...
def add_factor(df: pd.DataFrame, param=None, **kwargs) -> (pd.DataFrame, dict):
    ...
    """
    col_name = kwargs.get('col_name', 'large_scale_factor_71_fitness_0_483_20250812_175508')
    ...
    # 计算因子值
    factor_value = (((np.abs(o - c) - 56) ** 2).rolling(window=10).corr(((l - 51))))  # 原始GP表达式: CORRELATION10(SQUARED_DIFF(BODY_SIZE, NUMBER_56), SUBTRACT(LOW, NUMBER_51))
