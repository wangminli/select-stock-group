...
large_scale_factor_70_fitness_0_500_20250812_175508: 基于遗传规划算法生成的因子70，适应度: 0.500096
适应度分数: 0.500096
原始GP表达式: SUBTRACT(SQUARED_DIFF(DAILY_RANGE_RATIO, NUMBER_7), NUMBER_22)
...
def add_factor(df: pd.DataFrame, param=None, **kwargs) -> (pd.DataFrame, dict):
    ...
    """
    col_name = kwargs.get('col_name', 'large_scale_factor_70_fitness_0_500_20250812_175508')
    ...
    # 计算因子值
    factor_value = ((((h - l) / c.replace(0, np.nan) - 7) ** 2 - 22))  # 原始GP表达式: SUBTRACT(SQUARED_DIFF(DAILY_RANGE_RATIO, NUMBER_7), NUMBER_22)
