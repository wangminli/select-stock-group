...
large_scale_factor_40_fitness_0_200_20250812_175508: 基于遗传规划算法生成的因子40，适应度: 0.200200
适应度分数: 0.200200
原始GP表达式: TS_LAG(TS_VAR(RETURN5, NUMBER_27), NUMBER_27)
...
def add_factor(df: pd.DataFrame, param=None, **kwargs) -> (pd.DataFrame, dict):
    ...
    """
    col_name = kwargs.get('col_name', 'large_scale_factor_40_fitness_0_200_20250812_175508')
    ...
    # 计算因子值
    factor_value = (((c.pct_change(5)).rolling(window=27, min_periods=1).var()).shift(27))  # 原始GP表达式: TS_LAG(TS_VAR(RETURN5, NUMBER_27), NUMBER_27)
