...
large_scale_factor_14_fitness_0_596_20250812_175508: 基于遗传规划算法生成的因子14，适应度: 0.596497
适应度分数: 0.596497
原始GP表达式: SUBTRACT(CORRELATION10(HLC_TYPICAL, AMOUNT), NUMBER_44)
...
def add_factor(df: pd.DataFrame, param=None, **kwargs) -> (pd.DataFrame, dict):
    ...
    """
    col_name = kwargs.get('col_name', 'large_scale_factor_14_fitness_0_596_20250812_175508')
    ...
    # 计算因子值
    factor_value = ((((h + l + c) / 3).rolling(window=10).corr((amt)) - 44))  # 原始GP表达式: SUBTRACT(CORRELATION10(HLC_TYPICAL, AMOUNT), NUMBER_44)
