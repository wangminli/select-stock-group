...
large_scale_factor_82_fitness_0_374_20250812_175508: 基于遗传规划算法生成的因子82，适应度: 0.374154
适应度分数: 0.374154
原始GP表达式: DELTA(SQUARED_DIFF(NUMBER_8, AMOUNT), NUMBER_28)
...
def add_factor(df: pd.DataFrame, param=None, **kwargs) -> (pd.DataFrame, dict):
    ...
    """
    col_name = kwargs.get('col_name', 'large_scale_factor_82_fitness_0_374_20250812_175508')
    ...
    # 计算因子值
    factor_value = (((8 - amt) ** 2).diff(28))  # 原始GP表达式: DELTA(SQUARED_DIFF(NUMBER_8, AMOUNT), NUMBER_28)
