...
large_scale_factor_55_fitness_0_400_20250812_175508: 基于遗传规划算法生成的因子55，适应度: 0.400440
适应度分数: 0.400440
原始GP表达式: CORRELATION60(ABS_DIFF(TRUE_RANGE, NUMBER_54), DELTA(OPEN, NUMBER_12))
...
def add_factor(df: pd.DataFrame, param=None, **kwargs) -> (pd.DataFrame, dict):
    ...
    """
    col_name = kwargs.get('col_name', 'large_scale_factor_55_fitness_0_400_20250812_175508')
    ...
    # 计算因子值
    factor_value = ((np.abs(h - l - 54)).rolling(window=60).corr(((o).diff(12))))  # 原始GP表达式: CORRELATION60(ABS_DIFF(TRUE_RANGE, NUMBER_54), DELTA(OPEN, NUMBER_12))
