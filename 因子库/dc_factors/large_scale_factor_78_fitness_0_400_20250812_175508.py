...
large_scale_factor_78_fitness_0_400_20250812_175508: 基于遗传规划算法生成的因子78，适应度: 0.399657
适应度分数: 0.399657
原始GP表达式: SQUARED_DIFF(ABS_DIFF(LOW_CLOSE_RATIO, NUMBER_13), NUMBER_53)
...
def add_factor(df: pd.DataFrame, param=None, **kwargs) -> (pd.DataFrame, dict):
    ...
    """
    col_name = kwargs.get('col_name', 'large_scale_factor_78_fitness_0_400_20250812_175508')
    ...
    # 计算因子值
    factor_value = ((np.abs(l / c.replace(0, np.nan) - 13) - 53) ** 2)  # 原始GP表达式: SQUARED_DIFF(ABS_DIFF(LOW_CLOSE_RATIO, NUMBER_13), NUMBER_53)
