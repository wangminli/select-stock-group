...
large_scale_factor_73_fitness_0_473_20250812_175508: 基于遗传规划算法生成的因子73，适应度: 0.472762
适应度分数: 0.472762
原始GP表达式: MULTIPLY(CORRELATION10(CLOSE, HIGH_CLOSE_DIFF), NUMBER_28)
...
def add_factor(df: pd.DataFrame, param=None, **kwargs) -> (pd.DataFrame, dict):
    ...
    """
    col_name = kwargs.get('col_name', 'large_scale_factor_73_fitness_0_473_20250812_175508')
    ...
    # 计算因子值
    factor_value = (((c).rolling(window=10).corr((h - c)) * 28))  # 原始GP表达式: MULTIPLY(CORRELATION10(CLOSE, HIGH_CLOSE_DIFF), NUMBER_28)
