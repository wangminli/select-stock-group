...
large_scale_factor_23_fitness_0_279_20250812_175508: 基于遗传规划算法生成的因子23，适应度: 0.279037
适应度分数: 0.279037
原始GP表达式: SPEARMAN10(SUBTRACT(ZONGSHIZHI, NUMBER_25), SQUARED_DIFF(NUMBER_5, VOLUME))
...
def add_factor(df: pd.DataFrame, param=None, **kwargs) -> (pd.DataFrame, dict):
    ...
    """
    col_name = kwargs.get('col_name', 'large_scale_factor_23_fitness_0_279_20250812_175508')
    ...
    # 计算因子值
    factor_value = (((mc_total - 25)).rolling(window=10).corr(((5 - v) ** 2), method="spearman"))  # 原始GP表达式: SPEARMAN10(SUBTRACT(ZONGSHIZHI, NUMBER_25), SQUARED_DIFF(NUMBER_5, VOLUME))
