...
large_scale_factor_79_fitness_0_399_20250812_175508: 基于遗传规划算法生成的因子79，适应度: 0.399271
适应度分数: 0.399271
原始GP表达式: DIVIDE(TS_LAG(VOLUME_WEIGHTED_PRICE, NUMBER_26), ZONGSHIZHI)
...
def add_factor(df: pd.DataFrame, param=None, **kwargs) -> (pd.DataFrame, dict):
    ...
    """
    col_name = kwargs.get('col_name', 'large_scale_factor_79_fitness_0_399_20250812_175508')
    ...
    # 计算因子值
    factor_value = (((amt / v.replace(0, np.nan)).shift(26) / mc_total))  # 原始GP表达式: DIVIDE(TS_LAG(VOLUME_WEIGHTED_PRICE, NUMBER_26), ZONGSHIZHI)
