...
large_scale_factor_31_fitness_0_336_20250812_175508: 基于遗传规划算法生成的因子31，适应度: 0.336456
适应度分数: 0.336456
原始GP表达式: MULTIPLY(TS_LAG(HL_MID, NUMBER_46), TURNOVER)
...
def add_factor(df: pd.DataFrame, param=None, **kwargs) -> (pd.DataFrame, dict):
    ...
    """
    col_name = kwargs.get('col_name', 'large_scale_factor_31_fitness_0_336_20250812_175508')
    ...
    # 计算因子值
    factor_value = ((((h + l) / 2).shift(46) * v / mc_circ.replace(0, np.nan)))  # 原始GP表达式: MULTIPLY(TS_LAG(HL_MID, NUMBER_46), TURNOVER)
