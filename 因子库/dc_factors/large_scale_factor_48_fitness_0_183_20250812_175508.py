...
large_scale_factor_48_fitness_0_183_20250812_175508: 基于遗传规划算法生成的因子48，适应度: 0.182772
适应度分数: 0.182772
原始GP表达式: TS_LAG(TS_MAX(RETURN10, NUMBER_54), NUMBER_16)
...
def add_factor(df: pd.DataFrame, param=None, **kwargs) -> (pd.DataFrame, dict):
    ...
    """
    col_name = kwargs.get('col_name', 'large_scale_factor_48_fitness_0_183_20250812_175508')
    ...
    # 计算因子值
    factor_value = (((c.pct_change(10)).rolling(window=54, min_periods=1).max()).shift(16))  # 原始GP表达式: TS_LAG(TS_MAX(RETURN10, NUMBER_54), NUMBER_16)
