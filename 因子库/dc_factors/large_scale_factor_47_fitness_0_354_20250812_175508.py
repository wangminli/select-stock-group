...
large_scale_factor_47_fitness_0_354_20250812_175508: 基于遗传规划算法生成的因子47，适应度: 0.353509
适应度分数: 0.353509
原始GP表达式: RETURNS(TS_MEDIAN(TRUE_RANGE, NUMBER_46), NUMBER_53)
...
def add_factor(df: pd.DataFrame, param=None, **kwargs) -> (pd.DataFrame, dict):
    ...
    """
    col_name = kwargs.get('col_name', 'large_scale_factor_47_fitness_0_354_20250812_175508')
    ...
    # 计算因子值
    factor_value = (((h - l).rolling(window=46, min_periods=1).median()).pct_change(53))  # 原始GP表达式: RETURNS(TS_MEDIAN(TRUE_RANGE, NUMBER_46), NUMBER_53)
