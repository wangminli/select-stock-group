...
large_scale_factor_93_fitness_0_544_20250812_175508: 基于遗传规划算法生成的因子93，适应度: 0.544239
适应度分数: 0.544239
原始GP表达式: ADD(SUBTRACT(NUMBER_40, TURNOVER_RATIO), NUMBER_45)
...
def add_factor(df: pd.DataFrame, param=None, **kwargs) -> (pd.DataFrame, dict):
    ...
    """
    col_name = kwargs.get('col_name', 'large_scale_factor_93_fitness_0_544_20250812_175508')
    ...
    # 计算因子值
    factor_value = (((40 - v / mc_circ.replace(0, np.nan)) + 45))  # 原始GP表达式: ADD(SUBTRACT(NUMBER_40, TURNOVER_RATIO), NUMBER_45)
