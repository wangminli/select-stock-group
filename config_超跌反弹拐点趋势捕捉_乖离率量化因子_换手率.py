"""
标题：【北川】超跌反弹拐点趋势捕捉、乖离率量化因子、换手率_80.77%_-45.62%_1.77
链接：https://bbs.quantclass.cn/thread/68375
评价：原策略没有添加择时指标，我在此基础上添加了N日涨跌幅的择时指标，能有效控制回撤，还发了一篇文章： https://bbs.quantclass.cn/thread/68429
    15年回撤大小：大
	22、23年涨跌：22年上涨、23下下跌
	对数坐标轴斜率：斜率大，整体平稳！
策略评价：
0
累积净值 4799.48
...
单周期大亏损 -9.66%
最大连续盈利周期数 15.0
最大连续盈利开始日期 2013-03-05
最大连续盈利结束日期 2013-03-25
最大连续亏损周期数 26.0
最大连续亏损开始日期 2019-01-02
最大连续亏损结束日期 2019-02-13
收益率标准差 1.84%
"""
"""
邢不行™️选股框架
...
# ====================================================================================================
strategy = {
    'name': '超跌反弹拐点趋势捕捉_乖离率量化因子_换手率',  # 策略名
...
excluded_boards = ["cyb", "kcb", "bj"]  # 过滤板块，默认不过滤
...
#equity_timing = {"name": "动量_状态自适应择时", "params": [3, 5, 20, -0.05]} # 回撤缩小约40%，但收益大幅缩水
equity_timing = {"name": "N日涨跌幅择时", "params":[5,-0.07]}
